 ...
 * @author phidalgo
 */
public class GestionConsulados extends javax.swing.JFrame {

    /**
     * Creates new form GestionConsulado
     */
    public GestionConsulados() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GestionConsulados.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GestionConsulados().setVisible(true);
            }
        });
    }
